...
export const COMPONENT_URL={ tlp: API_SERVER+"administration/tlp/",
feed: API_SERVER+"administration/feed/",
priority: API_SERVER+"administration/priority/",
state: API_SERVER+"state/",
edge: API_SERVER+"edge/",
template: API_SERVER+"template/",
case: API_SERVER+"case/",
evidence: API_SERVER+"evidence/",
event: API_SERVER+"event/",
taxonomy: API_SERVER+"taxonomy/",
report: API_SERVER+"report/",
network: API_SERVER+"network/",
contact: API_SERVER+"contact/",
entity: API_SERVER+"entity/",
user: API_SERVER+"user/",
playbook: API_SERVER+"playbook/",
task: API_SERVER+"task/",
todo: API_SERVER+"todo/",
artifact: API_SERVER+"artifact/",
announcement: API_SERVER+"announcement/",
register: API_SERVER+"register/",
checkSession: API_SERVER+"checkSession/",
login: API_SERVER+"login/",
logout: API_SERVER+"logout/",
case: API_SERVER+"search/case/",};