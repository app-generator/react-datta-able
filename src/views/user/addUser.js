...
const AddUser = () => {
    ...
    const validatePriority=(event)=>{
        ...
        if (event.target.value !== "-1"){
            ...
            setBody({...body,
                    [event.target.name] : "http://localhost:8000/api/administration/priority/"+event.target.value+"/"}
                    )  
                        ...
                        <Card.Body>
                            <Form onSubmit={e=>enviar(e)}>
                                ...
                                <Form.Group controlId="formGridAddress1">
                                        ...
                                        <Form.Control placeholder="Ingrese el nombre del usuario" name="username" onChange={validateUsername}/>
                                </Form.Group>
