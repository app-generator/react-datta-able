                                ...
                                <Row>
                                    <Col sm={12} lg={4}>
                                        <Form.Group>
                                            ...
                                            <Form.Control style={{backgroundImage: "none"}} type="text" placeholder="Nombre" onChange={(e) => setName(e.target.value)} isValid={validateName(name)} isInvalid={!validateName(name)}/>
                                    ...
                                    <Col sm={12} lg={12}>
                                        <Form.Group> 
                                            ...
                                            <Form.Control style={{backgroundImage: "none"}} as="textarea" rows={3} placeholder="Descripcion" onChange={(e) => setDescription(e.target.value)}  isValid={validateDescription(description)} isInvalid={!validateDescription(description)} />
