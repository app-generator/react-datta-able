                                ...
                                <Row>
                                    <Col sm={12} lg={4}>
                                        <Form.Group>
                                            ...
                                            <Form.Control style={{backgroundImage: "none"}} type="text" defaultValue={taxonomy.name} onChange={(e) => setName(e.target.value)} isValid={validateName(name)} isInvalid={!validateName(name)}/>
                                    ...
                                    <Col sm={12} lg={3}>
                                        <Form.Group>
                                            ...
                                            <Form.Control style={{backgroundImage: "none"}} type="choice" as="select" value={type} onChange={(e) => setType(e.target.value)} isValid={validateType(type)} isInvalid={!validateType(type)} >                                                                     
                                ...
                                <Row>                                
                                    <Col sm={12} lg={12}>
                                        <Form.Group>
                                            ...
                                            <Form.Control style={{backgroundImage: "none"}} as="textarea" rows={3} defaultValue={taxonomy.description} onChange={(e) => setDescription(e.target.value)}  isValid={validateDescription(description)} isInvalid={!validateDescription(description)} />
